...
var
  frmSemaphoreLittle: TfrmSemaphoreLittle;
...
procedure TfrmSemaphoreLittle.lblPlayAllClick(Sender: TObject);
begin
  tempTime2 := 0;
  tmr2.Enabled := True;
end;

procedure TfrmSemaphoreLittle.lblBerandaClick(Sender: TObject);
begin
  Close
end;

procedure TfrmSemaphoreLittle.lblGroupMouseEnter(Sender: TObject);
begin
...
procedure TfrmSemaphoreLittle.lblGroupMouseLeave(Sender: TObject);
begin
  if Sender is TLabel then
  begin
...
procedure TfrmSemaphoreLittle.LoadHuruf(hrfVal: string);
begin
...
procedure TfrmSemaphoreLittle.btnGroupClick(Sender: TObject);
begin
...
procedure TfrmSemaphoreLittle.btnHurufClick(Sender: TObject);
begin
  LoadHuruf(TImage(Sender).Hint)
end;

procedure TfrmSemaphoreLittle.btnNextClick(Sender: TObject);
begin
  if (imgSpasi.Left <= 510) or (tmr1.Enabled) then
    Exit;
...
procedure TfrmSemaphoreLittle.btnPrevClick(Sender: TObject);
begin
...
procedure TfrmSemaphoreLittle.SetButtonHurufPosition(posVal: Integer);
begin
...
procedure TfrmSemaphoreLittle.tmr1Timer(Sender: TObject);
begin
  tempTime := tempTime + 5;
...
procedure TfrmSemaphoreLittle.tmr2Timer(Sender: TObject);
begin
